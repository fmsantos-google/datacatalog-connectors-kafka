...
from google.datacatalog_connectors.commons.ingest import \
...
class DataCatalogSynchronizer:
    ...
    def run(self):
        ...
        prepared_entries = factory.make_entries_from_topic_metadata(
            topics_metadata)

        self.__log_metadata(topics_metadata)
    ...
    def __log_metadata(self, metadata):
        topics_json = json.dumps(metadata)
